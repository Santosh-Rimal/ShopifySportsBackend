...
<nav class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700" x-data="{ open: false }">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link class="text-black dark:tezxt-white cursor-pointer" :href="route('category')" :active="request()->routeIs('category')"
                        wire:navigate>
                        {{ __('Categories') }}
                    </x-nav-link>

                    <x-nav-link class="text-black dark:text-white" :href="route('about')" :active="request()->routeIs('about')" wire:navigate>
                        {{ __('About Us') }}
                    </x-nav-link>
                    ...
                    <x-nav-link class="text-black dark:text-white" :href="route('contacts')" :active="request()->routeIs('contacts')" wire:navigate>
                        {{ __('Contact Us') }}
                    </x-nav-link>
                </div>
            </div>
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            ...
                            <img src="{{ Auth::user()->image }}" alt="Users Image" width="20px" height="20px">
    ...
    <div class="hidden sm:hidden" :class="{ 'block': open, 'hidden': !open }">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            <div class="px-4">
                <div class="flex">
                    <img class="inline" src="{{ Auth::user()->image }}" alt="Users Image" width="20px"
                        height="20px">
